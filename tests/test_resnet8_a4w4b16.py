...
PROJECT_NAME = "project_resnet8_a4w4b16_test"
ONNX_NAME = "resnet8_a4w4b32.onnx"
...
def test_resnet8_a8w8b16_compilation():
    result = subprocess.run(
        [
            "make", 
            "generate", 
            "TOP_NAME=resnet8_4bit", 
            f"ONNX_PATH=../models/onnx/{ONNX_NAME}", 
            "DATASET=cifar10_4bit", 
            "BOARD=KRIA", 
            "DYNAMIC_INIT=1", 
...
def test_resnet8_a8w8b16_csim_inference():
    result = subprocess.run(
        [
            "make", 
            "csim", 
