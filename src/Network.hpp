...
const int c_conv0_weight_bw   = 4;
const int c_conv0_weight_reuse = 0;
...
const int c_conv0_weight_ops = 1;
const int c_conv0_weight_index = 9;
const int c_conv0_weight_iter  = 49;
...
const int c_conv_129_a_split  = 0;
...
typedef struct {
	t_conv_129_skip data;
	bool last;
} t_conv_129_skip_struct;
typedef uint8_t t_conv_129_skip;


const int c_conv_2_ops  = 2;
const int c_layers_0_conv0_weight_bw   = 4;
const int c_layers_0_conv0_weight_reuse = 0;

typedef int8_t t_layers_0_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_2_ops> t_layers_0_conv0_weight;
...
const int c_layers_0_conv0_weight_ops = 2;
const int c_layers_0_conv0_weight_index = 9;
const int c_layers_0_conv0_weight_iter  = 129;
...
const int c_conv_131_a_split  = 0;
...
const int c_conv_4_ops  = 4;
const int c_layers_0_conv1_weight_bw   = 4;
const int c_layers_0_conv1_weight_reuse = 0;

typedef int8_t t_layers_0_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_4_ops> t_layers_0_conv1_weight;
...
const int c_layers_0_conv1_weight_ops = 4;
const int c_layers_0_conv1_weight_index = 9;
const int c_layers_0_conv1_weight_iter  = 65;
...
const int c_conv_134_a_split  = 0;
...
typedef struct {
	t_conv_134_skip data;
	bool last;
} t_conv_134_skip_struct;
typedef uint8_t t_conv_134_skip;


const int c_conv_7_ops  = 2;
const int c_layers_1_conv0_weight_bw   = 4;
const int c_layers_1_conv0_weight_reuse = 1;

typedef int8_t t_layers_1_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_7_ops> t_layers_1_conv0_weight;
...
const int c_layers_1_conv0_weight_ops = 2;
const int c_layers_1_conv0_weight_index = 9;
const int c_layers_1_conv0_weight_iter  = 129;
...
const int c_conv_136_a_split  = 0;
...
const int c_layers_1_conv1_weight_bw   = 4;
const int c_layers_1_conv1_weight_reuse = 0;

typedef int8_t t_layers_1_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_9_ops> t_layers_1_conv1_weight;
...
const int c_layers_1_conv1_weight_ops = 2;
const int c_layers_1_conv1_weight_index = 9;
const int c_layers_1_conv1_weight_iter  = 129;
...
const int c_conv_139_a_split  = 0;
...
typedef struct {
	t_conv_139_skip data;
	bool last;
} t_conv_139_skip_struct;
typedef uint8_t t_conv_139_skip;


const int c_conv_12_ops  = 2;
const int c_layers_2_conv0_weight_bw   = 4;
const int c_layers_2_conv0_weight_reuse = 0;

typedef int8_t t_layers_2_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_12_ops> t_layers_2_conv0_weight;
...
const int c_layers_2_conv0_weight_ops = 2;
const int c_layers_2_conv0_weight_index = 9;
const int c_layers_2_conv0_weight_iter  = 129;
...
const int c_conv_141_a_split  = 0;
...
const int c_layers_2_conv1_weight_bw   = 4;
const int c_layers_2_conv1_weight_reuse = 0;

typedef int8_t t_layers_2_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_14_ops> t_layers_2_conv1_weight;
...
const int c_layers_2_conv1_weight_ops = 2;
const int c_layers_2_conv1_weight_index = 9;
const int c_layers_2_conv1_weight_iter  = 129;
...
const int c_conv_144_a_split  = 2;
...
const int c_layers_3_skip_conv_weight_bw   = 4;
const int c_layers_3_skip_conv_weight_reuse = 0;

typedef int8_t t_layers_3_skip_conv_weight_st;
typedef hls::vector<int8_t, c_conv_17_ops> t_layers_3_skip_conv_weight;
...
const int c_layers_3_skip_conv_weight_ops = 1;
const int c_layers_3_skip_conv_weight_index = 1;
const int c_layers_3_skip_conv_weight_iter  = 513;
...
typedef uint8_t t_conv_144_skip1;

typedef struct {
	t_conv_144_skip1 data;
	bool last;
} t_conv_144_skip1_struct;
typedef uint8_t t_conv_144_skip1;


const int c_conv_19_ops  = 1;
const int c_layers_3_conv0_weight_bw   = 4;
const int c_layers_3_conv0_weight_reuse = 0;

typedef int8_t t_layers_3_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_19_ops> t_layers_3_conv0_weight;
...
const int c_layers_3_conv0_weight_ops = 1;
const int c_layers_3_conv0_weight_index = 9;
const int c_layers_3_conv0_weight_iter  = 513;
...
const int c_conv_148_a_split  = 0;
...
const int c_layers_3_conv1_weight_bw   = 4;
const int c_layers_3_conv1_weight_reuse = 0;

typedef int8_t t_layers_3_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_21_ops> t_layers_3_conv1_weight;
...
const int c_layers_3_conv1_weight_ops = 2;
const int c_layers_3_conv1_weight_index = 9;
const int c_layers_3_conv1_weight_iter  = 513;
...
const int c_conv_151_a_split  = 0;
...
typedef struct {
	t_conv_151_skip data;
	bool last;
} t_conv_151_skip_struct;
typedef uint8_t t_conv_151_skip;


const int c_conv_24_ops  = 2;
const int c_layers_4_conv0_weight_bw   = 4;
const int c_layers_4_conv0_weight_reuse = 1;

typedef int8_t t_layers_4_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_24_ops> t_layers_4_conv0_weight;
...
const int c_layers_4_conv0_weight_ops = 2;
const int c_layers_4_conv0_weight_index = 9;
const int c_layers_4_conv0_weight_iter  = 513;
...
const int c_conv_153_a_split  = 0;
...
const int c_conv_26_ops  = 2;
const int c_layers_4_conv1_weight_bw   = 4;
const int c_layers_4_conv1_weight_reuse = 1;

typedef int8_t t_layers_4_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_26_ops> t_layers_4_conv1_weight;
...
const int c_layers_4_conv1_weight_ops = 2;
const int c_layers_4_conv1_weight_index = 9;
const int c_layers_4_conv1_weight_iter  = 513;
...
const int c_conv_156_a_split  = 0;
...
typedef struct {
	t_conv_156_skip data;
	bool last;
} t_conv_156_skip_struct;
typedef uint8_t t_conv_156_skip;


const int c_conv_29_ops  = 2;
const int c_layers_5_conv0_weight_bw   = 4;
const int c_layers_5_conv0_weight_reuse = 1;

typedef int8_t t_layers_5_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_29_ops> t_layers_5_conv0_weight;
...
const int c_layers_5_conv0_weight_ops = 2;
const int c_layers_5_conv0_weight_index = 9;
const int c_layers_5_conv0_weight_iter  = 513;
...
const int c_conv_158_a_split  = 0;
...
const int c_layers_5_conv1_weight_bw   = 4;
const int c_layers_5_conv1_weight_reuse = 1;

typedef int8_t t_layers_5_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_31_ops> t_layers_5_conv1_weight;
...
const int c_layers_5_conv1_weight_ops = 2;
const int c_layers_5_conv1_weight_index = 9;
const int c_layers_5_conv1_weight_iter  = 513;
...
const int c_conv_161_a_split  = 2;
...
const int c_layers_6_skip_conv_weight_bw   = 4;
const int c_layers_6_skip_conv_weight_reuse = 0;

typedef int8_t t_layers_6_skip_conv_weight_st;
typedef hls::vector<int8_t, c_conv_34_ops> t_layers_6_skip_conv_weight;
...
const int c_layers_6_skip_conv_weight_ops = 1;
const int c_layers_6_skip_conv_weight_index = 1;
const int c_layers_6_skip_conv_weight_iter  = 2049;
...
typedef uint8_t t_conv_161_skip1;

typedef struct {
	t_conv_161_skip1 data;
	bool last;
} t_conv_161_skip1_struct;
typedef uint8_t t_conv_161_skip1;


const int c_conv_36_ops  = 1;
const int c_layers_6_conv0_weight_bw   = 4;
const int c_layers_6_conv0_weight_reuse = 0;

typedef int8_t t_layers_6_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_36_ops> t_layers_6_conv0_weight;
...
const int c_layers_6_conv0_weight_ops = 1;
const int c_layers_6_conv0_weight_index = 9;
const int c_layers_6_conv0_weight_iter  = 2049;
...
const int c_conv_165_a_split  = 0;
...
const int c_layers_6_conv1_weight_bw   = 4;
const int c_layers_6_conv1_weight_reuse = 1;

typedef int8_t t_layers_6_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_38_ops> t_layers_6_conv1_weight;
...
const int c_layers_6_conv1_weight_ops = 2;
const int c_layers_6_conv1_weight_index = 9;
const int c_layers_6_conv1_weight_iter  = 2049;
...
const int c_conv_168_a_split  = 0;
...
typedef struct {
	t_conv_168_skip data;
	bool last;
} t_conv_168_skip_struct;
typedef uint8_t t_conv_168_skip;


const int c_conv_41_ops  = 2;
const int c_layers_7_conv0_weight_bw   = 4;
const int c_layers_7_conv0_weight_reuse = 0;

typedef int8_t t_layers_7_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_41_ops> t_layers_7_conv0_weight;
...
const int c_layers_7_conv0_weight_ops = 2;
const int c_layers_7_conv0_weight_index = 9;
const int c_layers_7_conv0_weight_iter  = 2049;
...
const int c_conv_170_a_split  = 0;
...
const int c_layers_7_conv1_weight_bw   = 4;
const int c_layers_7_conv1_weight_reuse = 0;

typedef int8_t t_layers_7_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_43_ops> t_layers_7_conv1_weight;
...
const int c_layers_7_conv1_weight_ops = 2;
const int c_layers_7_conv1_weight_index = 9;
const int c_layers_7_conv1_weight_iter  = 2049;
...
const int c_conv_173_a_split  = 0;
...
typedef struct {
	t_conv_173_skip data;
	bool last;
} t_conv_173_skip_struct;
typedef uint8_t t_conv_173_skip;


const int c_conv_46_ops  = 2;
const int c_layers_8_conv0_weight_bw   = 4;
const int c_layers_8_conv0_weight_reuse = 1;

typedef int8_t t_layers_8_conv0_weight_st;
typedef hls::vector<int8_t, c_conv_46_ops> t_layers_8_conv0_weight;
...
const int c_layers_8_conv0_weight_ops = 2;
const int c_layers_8_conv0_weight_index = 9;
const int c_layers_8_conv0_weight_iter  = 2049;
...
const int c_conv_175_a_split  = 0;
...
const int c_layers_8_conv1_weight_bw   = 4;
const int c_layers_8_conv1_weight_reuse = 1;

typedef int8_t t_layers_8_conv1_weight_st;
typedef hls::vector<int8_t, c_conv_48_ops> t_layers_8_conv1_weight;
...
const int c_layers_8_conv1_weight_ops = 2;
const int c_layers_8_conv1_weight_index = 9;
const int c_layers_8_conv1_weight_iter  = 2049;
...
typedef struct {
	t_averagepool_180 data;
	bool last;
} t_averagepool_180_struct;
...
const int c_fc_weight_bw   = 4;
const int c_fc_weight_reuse = 1;

typedef int8_t t_fc_weight_st;
typedef hls::vector<int8_t, c_conv_54_ops> t_fc_weight;
...
const int c_fc_weight_iter  = 641;
