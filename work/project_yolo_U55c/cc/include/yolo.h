...
#pragma HLS INTERFACE mode = m_axi port = o_outp1 bundle = m_axi_o depth = 86528 channel=0
#pragma HLS INTERFACE mode = m_axi port = o_outp2 bundle = m_axi_o depth = 173056 channel=1
	// #pragma HLS interface mode = ap_ctrl_hs port = return
	// #pragma HLS dataflow disable_start_propagation
	// #pragma HLS INTERFACE mode = m_axi port = c_params bundle = m_axi_w depth=8649648
	...
	#pragma HLS stream variable=s_net_5_adj depth=2 type=fifo
	...
	t_node_conv_1_weight_mem static c_node_conv_1_weight[9][16][3];
	...
	t_node_conv_3_weight_mem static c_node_conv_3_weight[9][32][16];
	...
	#pragma HLS stream variable=s_net_10 depth=33 type=fifo
	hls::stream<t_net_10_adj_struct> s_net_10_adj[1];
	#pragma HLS stream variable=s_net_10_adj depth=17 type=fifo
	...
	t_node_conv_7_weight_mem static c_node_conv_7_weight[9][256][32];
	...
	#pragma HLS bind_storage variable=c_node_conv_9_weight impl=uram type=ram_s2p
	...
	t_node_conv_11_weight_mem static c_node_conv_11_weight[9][4096][32];
	...
	#pragma HLS stream variable=s_net_16_data[0] depth=64 type=fifo
	#pragma HLS bind_storage variable=s_net_16_data[0] impl=AUTO type=fifo
	#pragma HLS stream variable=s_net_16_data[1] depth=64 type=fifo
	#pragma HLS stream variable=s_net_16_data[2] depth=832 type=fifo
	#pragma HLS stream variable=s_net_16_data[3] depth=64 type=fifo
	#pragma HLS stream variable=s_net_16_data[4] depth=64 type=fifo
	#pragma HLS stream variable=s_net_16_data[5] depth=832 type=fifo
	#pragma HLS stream variable=s_net_16_data[6] depth=64 type=fifo
	#pragma HLS stream variable=s_net_16_data[7] depth=64 type=fifo
	...
	t_node_conv_12_weight_mem static c_node_conv_12_weight[9][4096][128];
	...
	t_node_conv_13_weight_mem static c_node_conv_13_weight[1][4096][64];
	...
	#pragma HLS stream variable=s_net_18 depth=33 type=fifo
	hls::stream<t_net_18_dup_0_struct> s_net_18_dup_0[1];
	hls::stream<t_net_18_dup_1_struct> s_net_18_dup_1[1];
	#pragma HLS stream variable=s_net_18_dup_0 depth=33 type=fifo
	#pragma HLS stream variable=s_net_18_dup_1 depth=33 type=fifo
	...
	#pragma HLS stream variable=s_net_18_dup_0_data[0] depth=64 type=fifo
	#pragma HLS bind_storage variable=s_net_18_dup_0_data[0] impl=AUTO type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[1] depth=64 type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[2] depth=832 type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[3] depth=64 type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[4] depth=64 type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[5] depth=832 type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[6] depth=64 type=fifo
	#pragma HLS stream variable=s_net_18_dup_0_data[7] depth=64 type=fifo
	...
	t_node_conv_14_weight_mem static c_node_conv_14_weight[9][4096][32];
	...
	#pragma HLS stream variable=s_net_19 depth=65 type=fifo
	...
	t_node_conv_15_weight_mem static c_node_conv_15_weight[1][4096][8];
	...
	#pragma HLS stream variable=s_net_23 depth=100 type=fifo
	hls::stream<t_net_20_struct> s_net_24_pre_adj[1];
	#pragma HLS stream variable=s_net_24_pre_adj depth=100 type=fifo
	...
	#pragma HLS stream variable=s_net_24_data[0] depth=32 type=fifo
	#pragma HLS bind_storage variable=s_net_24_data[0] impl=AUTO type=fifo
	#pragma HLS stream variable=s_net_24_data[1] depth=32 type=fifo
	#pragma HLS stream variable=s_net_24_data[2] depth=832 type=fifo
	#pragma HLS stream variable=s_net_24_data[3] depth=32 type=fifo
	#pragma HLS stream variable=s_net_24_data[4] depth=32 type=fifo
	#pragma HLS stream variable=s_net_24_data[5] depth=832 type=fifo
	#pragma HLS stream variable=s_net_24_data[6] depth=32 type=fifo
	#pragma HLS stream variable=s_net_24_data[7] depth=32 type=fifo
	...
	t_node_conv_18_weight_mem static c_node_conv_18_weight[9][1024][96];
	static bool s_node_conv_18_init_flag = false;
	hls::stream<t_params_stream> s_node_conv_18_out[1];
	#pragma HLS bind_storage variable=c_node_conv_18_weight impl=uram type=ram_s2p
	...
	#pragma HLS stream variable=s_net_25 depth=33 type=fifo
	...
	nn2fpga::bandwidth_adjust <
		t_net_5_struct,
		t_net_5_adj_struct,
		c_bandwidth_adjust_net_5_ich,
		c_bandwidth_adjust_net_5_iw,
		c_bandwidth_adjust_net_5_ih,
		c_bandwidth_adjust_net_5_ow_ops_in,
		c_bandwidth_adjust_net_5_ow_ops,
		c_bandwidth_adjust_net_5_old_in_ops,
		c_bandwidth_adjust_net_5_in_ops,
	...
	nn2fpga::bandwidth_adjust <
		t_net_6_struct,
		t_net_6_adj_struct,
		c_bandwidth_adjust_net_6_ich,
		c_bandwidth_adjust_net_6_iw,
		c_bandwidth_adjust_net_6_ih,
		c_bandwidth_adjust_net_6_ow_ops_in,
		c_bandwidth_adjust_net_6_ow_ops,
		c_bandwidth_adjust_net_6_old_in_ops,
		c_bandwidth_adjust_net_6_in_ops,
		false>		//skip connection flag
	(
		s_net_6,
		s_net_6_adj
	...
	nn2fpga::pool_op <
		...
		c_node_pool_6_pool,
		c_node_pool_6_ow_ops,
		c_node_pool_6_ops,  //to check
		c_node_pool_6_in_ops> //to check
	(
		s_net_10_compute,
		s_net_11
	);

	hls::stream<t_net_11_adj_struct> s_net_11_adj[1];
	nn2fpga::bandwidth_adjust <
		t_net_11_struct,
		t_net_11_adj_struct,
	...
	nn2fpga::tensor_duplicator <
		...
		26,		//Tensor height
		26,		//Tensor width
		c_node_conv_9_ops_out,		//Number of channel packed per packet
		c_node_conv_9_ow_ops_out>		//Number of streams in parallel
	(
		s_net_14,
		s_net_14_dup_0,
		s_net_14_dup_1
	...
	nn2fpga::bandwidth_adjust <
		t_net_15_struct,
		t_net_15_adj_struct,
		c_bandwidth_adjust_net_15_ich,
		c_bandwidth_adjust_net_15_iw,
		c_bandwidth_adjust_net_15_ih,
		c_bandwidth_adjust_net_15_ow_ops_in,
		c_bandwidth_adjust_net_15_ow_ops,
		c_bandwidth_adjust_net_15_old_in_ops,
		c_bandwidth_adjust_net_15_in_ops,
		false>		//skip connection flag
	(
		s_net_15,
		s_net_15_adj
	...
	nn2fpga::tensor_duplicator <
		...
		13,		//Tensor height
		13,		//Tensor width
		c_node_conv_13_ops_out,		//Number of channel packed per packet
		c_node_conv_13_ow_ops_out>		//Number of streams in parallel
	(
		s_net_18,
		s_net_18_dup_0,
		s_net_18_dup_1
...
// new
	...
	nn2fpga::bandwidth_adjust <
		...
		c_bandwidth_adjust_net_18_dup_1_ich,
		c_bandwidth_adjust_net_18_dup_1_iw,
		c_bandwidth_adjust_net_18_dup_1_ih,
		c_bandwidth_adjust_net_18_dup_1_ow_ops_in,
		c_bandwidth_adjust_net_18_dup_1_ow_ops,
		c_bandwidth_adjust_net_18_dup_1_old_in_ops,
		c_bandwidth_adjust_net_18_dup_1_in_ops,
		false>		//skip connection flag
	(
		s_net_18_dup_1,
		s_net_18_dup_1_adj
