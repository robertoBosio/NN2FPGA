...
/************************* bandwidth_adjust *************************/
typedef t_net_5 t_net_5_adj;
typedef std::array<t_net_5, 3> t_net_5_adj_vector;
typedef struct {
	std::array<t_net_5_adj_vector, 1> data;
	bool last;
} t_net_5_adj_struct;
const int c_bandwidth_adjust_net_5_ich = 3;
const int c_bandwidth_adjust_net_5_ih = 416;
const int c_bandwidth_adjust_net_5_iw = 416;
const int c_bandwidth_adjust_net_5_ow_ops_in = 1;
const int c_bandwidth_adjust_net_5_ow_ops = 4;
const int c_bandwidth_adjust_net_5_old_in_ops = 3;
const int c_bandwidth_adjust_net_5_in_ops = 3;
...
typedef std::array<t_net_5_reduce, 18> t_net_5_window;
typedef struct {
	t_net_5_window data;
	bool last;
...
typedef std::array<t_net_6, 8> t_net_6_vector;
typedef struct {
...
const int c_node_conv_1_ops = 1;
const int c_node_conv_1_ops_out = 8;
const int c_node_conv_1_in_ops = 3;
const int c_node_conv_1_ich_ops = 3;
const int c_node_conv_1_index = 9;
const int c_node_conv_1_reuse = 4;
const int c_node_conv_1_ow_ops = 4;
const int c_node_conv_1_ow_ops_out = 4;
const int c_node_conv_1_ow_pack = 2;
const int c_node_conv_1_och_pack = 1;
const int c_net_6_add_ops = 8;

/************************* bandwidth_adjust *************************/
typedef t_net_6 t_net_6_adj;
typedef std::array<t_net_6, 8> t_net_6_adj_vector;
typedef struct {
	std::array<t_net_6_adj_vector, 1> data;
	bool last;
} t_net_6_adj_struct;
const int c_bandwidth_adjust_net_6_ich = 16;
const int c_bandwidth_adjust_net_6_ih = 416;
const int c_bandwidth_adjust_net_6_iw = 416;
const int c_bandwidth_adjust_net_6_ow_ops_in = 4;
const int c_bandwidth_adjust_net_6_ow_ops = 1;
const int c_bandwidth_adjust_net_6_old_in_ops = 8;
const int c_bandwidth_adjust_net_6_in_ops = 8;

/************************* pool_op *************************/
typedef ap_ufixed<8, 3, AP_RND_CONV, AP_SAT> t_net_7;
typedef std::array<t_net_7, 8> t_net_7_vector;
typedef struct {
	std::array<t_net_7_vector, 1> data;
	bool last;
} t_net_7_struct;
typedef std::array<t_net_6, 8> t_net_6_reduce;
...
const int c_node_pool_2_ops = 8;
const int c_node_pool_2_in_ops = 8;

/************************* bandwidth_adjust *************************/
typedef t_net_7 t_net_7_adj;
typedef std::array<t_net_7, 8> t_net_7_adj_vector;
typedef struct {
...
const int c_bandwidth_adjust_net_7_old_in_ops = 8;
const int c_bandwidth_adjust_net_7_in_ops = 8;
...
typedef std::array<t_net_7, 4> t_net_7_reduce;
...
typedef std::array<t_net_8, 4> t_net_8_vector;
typedef struct {
...
const int c_node_conv_3_ops = 4;
const int c_node_conv_3_ops_out = 4;
const int c_node_conv_3_in_ops = 8;
const int c_node_conv_3_ich_ops = 4;
...
const int c_net_8_add_ops = 4;

/************************* bandwidth_adjust *************************/
typedef t_net_8 t_net_8_adj;
typedef std::array<t_net_8, 4> t_net_8_adj_vector;
typedef struct {
...
const int c_bandwidth_adjust_net_8_old_in_ops = 4;
const int c_bandwidth_adjust_net_8_in_ops = 4;

/************************* pool_op *************************/
typedef ap_ufixed<8, 3, AP_RND_CONV, AP_SAT> t_net_9;
typedef std::array<t_net_9, 4> t_net_9_vector;
typedef struct {
	std::array<t_net_9_vector, 1> data;
	bool last;
} t_net_9_struct;
typedef std::array<t_net_8, 4> t_net_8_reduce;
...
const int c_node_pool_4_ops = 4;
const int c_node_pool_4_in_ops = 4;

/************************* bandwidth_adjust *************************/
typedef t_net_9 t_net_9_adj;
typedef std::array<t_net_9, 4> t_net_9_adj_vector;
typedef struct {
...
const int c_bandwidth_adjust_net_9_old_in_ops = 4;
const int c_bandwidth_adjust_net_9_in_ops = 4;
...
typedef std::array<t_net_9, 4> t_net_9_reduce;
...
typedef std::array<t_net_10, 4> t_net_10_vector;
typedef struct {
...
const int c_node_conv_5_ops = 4;
const int c_node_conv_5_ops_out = 4;
const int c_node_conv_5_in_ops = 4;
const int c_node_conv_5_ich_ops = 4;
...
const int c_net_10_add_ops = 4;

/************************* bandwidth_adjust *************************/
typedef t_net_10 t_net_10_adj;
typedef std::array<t_net_10, 4> t_net_10_adj_vector;
typedef struct {
...
const int c_bandwidth_adjust_net_10_old_in_ops = 4;
const int c_bandwidth_adjust_net_10_in_ops = 4;

/************************* pool_op *************************/
typedef ap_ufixed<8, 3, AP_RND_CONV, AP_SAT> t_net_11;
typedef std::array<t_net_11, 2> t_net_11_vector;
typedef struct {
	std::array<t_net_11_vector, 1> data;
	bool last;
} t_net_11_struct;
typedef std::array<t_net_10, 2> t_net_10_reduce;
typedef std::array<t_net_10_reduce, 4> t_net_10_window;
// typedef std::array<t_net_10_reduce, 8> t_net_10_window;
typedef struct {
...
const int c_node_pool_6_ops = 2;
// const int c_node_pool_6_in_ops = 4;
const int c_node_pool_6_in_ops = 2;
...
const int c_bandwidth_adjust_net_11_ow_ops = 1;
const int c_bandwidth_adjust_net_11_old_in_ops = 2;
...
typedef std::array<t_net_11_reduce, 9> t_net_11_window;
typedef struct {
...
typedef std::array<t_net_12, 4> t_net_12_vector;
typedef struct {
...
const int c_node_conv_7_ops = 4;
const int c_node_conv_7_ops_out = 4;
const int c_node_conv_7_in_ops = 8;
const int c_node_conv_7_ich_ops = 8;
const int c_node_conv_7_index = 9;
const int c_node_conv_7_reuse = 1;
const int c_node_conv_7_ow_ops = 1;
const int c_node_conv_7_ow_ops_out = 1;
const int c_node_conv_7_ow_pack = 1;
const int c_node_conv_7_och_pack = 2;
const int c_net_12_add_ops = 4;

/************************* pool_op *************************/
typedef ap_ufixed<8, 3, AP_RND_CONV, AP_SAT> t_net_13;
typedef std::array<t_net_13, 1> t_net_13_vector;
typedef struct {
	std::array<t_net_13_vector, 1> data;
	bool last;
} t_net_13_struct;
typedef std::array<t_net_12, 1> t_net_12_reduce;
...
const int c_node_pool_8_ops = 1;
// const int c_node_pool_8_in_ops = 4;
const int c_node_pool_8_in_ops = 1;
/************************* bandwidth_adjust *************************/
typedef t_net_13 t_net_13_adj;
typedef std::array<t_net_13, 4> t_net_13_adj_vector;
typedef struct {
...
// const int c_bandwidth_adjust_net_13_old_in_ops = 4;
const int c_bandwidth_adjust_net_13_old_in_ops = 1;
const int c_bandwidth_adjust_net_13_in_ops = 4;
...
typedef std::array<t_net_13, 4> t_net_13_reduce;
...
typedef std::array<t_net_14, 4> t_net_14_vector;
typedef struct {
...
const int c_node_conv_9_ops = 4;
const int c_node_conv_9_ops_out = 4;
const int c_node_conv_9_in_ops = 4;
const int c_node_conv_9_ich_ops = 4;
...
typedef std::array<t_net_14_dup_0, 4> t_net_14_dup_0_adj_vector;
typedef struct {
...
const int c_bandwidth_adjust_net_14_dup_0_old_in_ops = 4;
const int c_bandwidth_adjust_net_14_dup_0_in_ops = 4;

/************************* pool_op *************************/
typedef ap_ufixed<8, 3, AP_RND_CONV, AP_SAT> t_net_15;
typedef std::array<t_net_15, 1> t_net_15_vector;
typedef struct {
	std::array<t_net_15_vector, 1> data;
	bool last;
} t_net_15_struct;
typedef std::array<t_net_14_dup_0, 1> t_net_14_dup_0_reduce;
...
const int c_node_pool_10_ops = 1;
// const int c_node_pool_10_in_ops = 4;
const int c_node_pool_10_in_ops = 1;

/************************* bandwidth_adjust *************************/
typedef t_net_15 t_net_15_adj;
typedef std::array<t_net_15, 4> t_net_15_adj_vector;
typedef struct {
	std::array<t_net_15_adj_vector, 1> data;
	bool last;
} t_net_15_adj_struct;
const int c_bandwidth_adjust_net_15_ich = 256;
const int c_bandwidth_adjust_net_15_ih = 13;
const int c_bandwidth_adjust_net_15_iw = 13;
const int c_bandwidth_adjust_net_15_ow_ops_in = 1;
const int c_bandwidth_adjust_net_15_ow_ops = 1;
const int c_bandwidth_adjust_net_15_old_in_ops = 1;
const int c_bandwidth_adjust_net_15_in_ops =4;
...
typedef std::array<t_net_15, 4> t_net_15_reduce;
...
typedef std::array<t_net_16, 8> t_net_16_vector;
typedef struct {
...
const int c_node_conv_11_ops = 8;
const int c_node_conv_11_ops_out = 8;
const int c_node_conv_11_in_ops = 4;
const int c_node_conv_11_ich_ops = 4;
...
typedef std::array<t_net_16, 8> t_net_16_reduce;
...
const int c_node_conv_12_in_ops = 8;
const int c_node_conv_12_ich_ops = 8;
...
typedef std::array<t_net_17, 8> t_net_17_reduce;
...
typedef std::array<t_net_18, 8> t_net_18_vector;
typedef struct {
...
const int c_node_conv_13_ops = 8;
const int c_node_conv_13_ops_out = 8;
const int c_node_conv_13_in_ops = 16;
const int c_node_conv_13_ich_ops = 8;
...
/************************* bandwidth_adjust *************************/
typedef t_net_18_dup_1 t_net_18_dup_1_adj;
typedef std::array<t_net_18_dup_1, 4> t_net_18_dup_1_adj_vector;
typedef struct {
	std::array<t_net_18_dup_1_adj_vector, 1> data;
	bool last;
} t_net_18_dup_1_adj_struct;
const int c_bandwidth_adjust_net_18_dup_1_ich = 256;
const int c_bandwidth_adjust_net_18_dup_1_ih = 13;
const int c_bandwidth_adjust_net_18_dup_1_iw = 13;
const int c_bandwidth_adjust_net_18_dup_1_ow_ops_in = 1;
const int c_bandwidth_adjust_net_18_dup_1_ow_ops = 1;
const int c_bandwidth_adjust_net_18_dup_1_old_in_ops = 8;
const int c_bandwidth_adjust_net_18_dup_1_in_ops = 4;
...
typedef std::array<t_net_18_dup_0, 4> t_net_18_dup_0_reduce;
...
typedef std::array<t_net_19, 8> t_net_19_vector;
typedef struct {
...
const int c_node_conv_14_ops = 8;
const int c_node_conv_14_ops_out = 8;
const int c_node_conv_14_in_ops = 8;
const int c_node_conv_14_ich_ops = 4;
...
typedef std::array<t_net_18_dup_1_adj, 2> t_net_18_dup_1_reduce;
...
const int c_node_conv_15_ich_ops = 2;
...
typedef std::array<t_net_23, 1> t_net_23_vector;
typedef struct {
...
typedef std::array<t_net_24, 12> t_net_24_reduce;
...
typedef std::array<t_net_25, 8> t_net_25_vector;
typedef struct {
...
const int c_node_conv_18_ops = 8;
const int c_node_conv_18_ops_out = 8;
const int c_node_conv_18_in_ops = 12;
const int c_node_conv_18_ich_ops = 12;
...
const int c_consume_stream_node_consume_25_ops = 8;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 2, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_1_weight_mem;
typedef std::array<std::array<t_node_conv_1_weight_mem, 1>, 3> t_node_conv_1_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 2, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_3_weight_mem;
typedef std::array<std::array<t_node_conv_3_weight_mem, 4>, 4> t_node_conv_3_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 1, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_5_weight_mem;
typedef std::array<std::array<t_node_conv_5_weight_mem, 4>, 4> t_node_conv_5_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 1, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_7_weight_mem;
typedef std::array<std::array<t_node_conv_7_weight_mem, 4>, 8> t_node_conv_7_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 0, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_9_weight_mem;
typedef std::array<std::array<t_node_conv_9_weight_mem, 4>, 4> t_node_conv_9_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 0, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_11_weight_mem;
typedef std::array<std::array<t_node_conv_11_weight_mem, 8>, 4> t_node_conv_11_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, -1, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_12_weight_mem;
typedef std::array<std::array<t_node_conv_12_weight_mem, 16>, 8> t_node_conv_12_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 0, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_13_weight_mem;
typedef std::array<std::array<t_node_conv_13_weight_mem, 8>, 8> t_node_conv_13_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, -1, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_14_weight_mem;
typedef std::array<std::array<t_node_conv_14_weight_mem, 8>, 4> t_node_conv_14_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, 0, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_15_weight_mem;
typedef std::array<std::array<t_node_conv_15_weight_mem, 4>, 2> t_node_conv_15_weight;

/************************* fake_func_params *************************/
typedef ap_fixed<8, -1, AP_RND_ZERO, AP_SAT_SYM> t_node_conv_18_weight_mem;
typedef std::array<std::array<t_node_conv_18_weight_mem, 8>, 12> t_node_conv_18_weight;
