...
std::chrono::duration<double> networkSim(
	...
	const int c_params_dim = 78052;
	t_params_st *c_params;
	
	posix_memalign((void**)&c_params, 4096, 78052 * sizeof(t_params_st));
	...
	file_weights.read(reinterpret_cast<char*>(c_params), 78052 * sizeof(t_params_st));
	file_weights.close();
