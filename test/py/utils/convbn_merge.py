...
def merge_conv_bn(model):
    ...
    merge_bn(model.module.layer2[0].downsample[0],
             model.module.layer2[0].downsample[1])
    model.module.layer2[0].downsample[1] = torch.nn.Identity()
    merge_bn(model.module.layer3[0].downsample[0],
             model.module.layer3[0].downsample[1])
