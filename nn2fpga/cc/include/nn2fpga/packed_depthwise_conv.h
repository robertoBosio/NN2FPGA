#ifndef NN2FPGA_PACKED_DEPTH_CONV_H_
#define NN2FPGA_PACKED_DEPTH_CONV_H_
...
// Write template for the depth_conv_pipe function.
...
void depth_conv_comp(hls::stream<t_input_struct> i_input[c_index],
...
#pragma HLS unroll factor = c_ops
        ...
        if constexpr(std::is_same<t_acc_1x1_struct, std::nullptr_t>::value == false) {
          ...
          s_acc_1x1_struct[s_ops] = depth_conv_pipe<
            t_input,
            t_weight_1x1,
            t_bias_1x1,
            std::nullptr_t,
...
template <class t_output_struct, class t_output, class t_output_clip,
          ...
          class t_acc, int c_och, int c_oh, int c_ow, int c_index,
...
#pragma HLS pipeline style = stp
    ...
    quant_stream<t_output_struct, t_output, t_output_clip, t_output_mask, t_acc_struct, t_acc, c_och,
...
#endif // NN2FPGA_PACKED_DEPTH_CONV_H_
