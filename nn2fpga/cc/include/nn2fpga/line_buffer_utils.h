         ...
         hls::stream<dout_t>& o_data)
{
  ...
  #pragma HLS array_partition variable=s_output.data type=complete
    ...
    std::cout << "\t\tc_ops_out = " << c_ops_out << std::endl;
    std::cout << "\t\tc_paddingh_shift = " << c_paddingh_shift << " but now: " << c_top_border << std::endl;
    std::cout << "\t\tc_paddingw_shift = " << c_paddingw_shift << " but now: " << c_left_border << std::endl;
    std::cout << "\t\tc_end_paddingh_shift = " << c_end_paddingh_shift << " but now: " << c_bottom_border << std::endl;
    std::cout << "\t\tc_end_paddingw_shift = " << c_end_paddingw_shift << " but now: " << c_right_border << std::endl;
    std::cout << "\t\tc_starth = " << c_starth << std::endl;
    std::cout << "\t\tc_startw = " << c_startw << std::endl;
    std::cout << "\t\tc_str_adj = " << c_str_adj << std::endl;
    std::cout << "\t\tc_strw_adj = " << c_strw_adj << std::endl;
