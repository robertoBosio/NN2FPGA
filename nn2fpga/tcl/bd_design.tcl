...
proc create_root_design { parentCell topName } {
...
\
  ...
  connect_bd_intf_net -intf_net ${topName}_0_o_net_conv_30 [get_bd_intf_pins ${topName}_0/o_outp1] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
