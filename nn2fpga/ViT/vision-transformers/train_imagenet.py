...
from models import *
from utils import progress_bar, ImageNetKaggle
...
# parser.add_argument('--data', default='/home/datasets/Imagenet/ILSVRC/Data/DET', type=str, help="path to imagent dataset")
...
# Data loading code
train_dataset = ImageNetKaggle(args.data, "train", train_transform)
trainloader = dataloader = DataLoader(
            train_dataset,
            batch_size=args.bs, # may need to reduce this depending on your GPU 
