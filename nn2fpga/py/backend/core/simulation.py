...
def dump_tcl_script(top_name, parts, t_clk, hls_version, input_files):
    ...
    return "\n".join(lines).format(
        top_name=top_name, tb_files=tb_files, parts=parts, t_clk=t_clk, argv=argv
    )
