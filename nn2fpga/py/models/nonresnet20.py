...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, weight_bits=8):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        layers = []
        layers.append(block(inplanes = self.inplanes, planes = planes, stride = stride, weight_bits=self.weight_bits))
