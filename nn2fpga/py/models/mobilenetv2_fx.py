...
from brevitas.nn import QuantConv2d, QuantIdentity, QuantReLU, QuantMaxPool2d, QuantLinear
...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.conv1 = QuantConv2d(3, 32, kernel_size=3, stride=2, padding=1, bias=False,
                weight_quant = Int8WeightPerTensorFixedPoint,
                bias_quant = Int16Bias,
                input_quant = Int8ActPerTensorFixedPoint,
                #output_quant = Int8ActPerTensorFixedPoint,
