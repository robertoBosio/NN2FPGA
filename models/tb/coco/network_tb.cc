...
int main(int argc, char** argv) {
  ...
  posix_memalign((void**)&mem_outputs1, 4096, 512 * 13 * 13 * c_batch * sizeof(t_out_mem1));
  t_out_mem2 *mem_outputs2;
  posix_memalign((void**)&mem_outputs2, 4096, 256 * 26 * 26 * c_batch * sizeof(t_out_mem2));
  std::cout << "Allocated " << c_index * c_batch << " ap_uint<64> for activations." << std::endl;
  std::cout << "Allocated " << 512 * 13 * 13 * c_batch << " ap_uint<8> for output1 results." << std::endl;
  std::cout << "Allocated " << 256 * 26 * 26 * c_batch << " ap_uint<8> for output2 results." << std::endl;
  ...
  inference_time = networkSim(argc,
                              ...
                              &mem_outputs1[i * 512 * 13 * 13],
                              &mem_outputs2[i * 256 * 26 * 26]);
#endif /* CSIM */
  }
